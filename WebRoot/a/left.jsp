...
%>
<div class="links">
	<a href="user_ManageAll.action"><span style=" line-height:50px;"><font
			color="white">用 户 管 理</font> </span> </a>
</div>
<%
	}
%>
<div class="links">
	<a href="topic_ManageAll.action"><span style=" line-height:50px;"><font
			color="white">帖 子 管 理</font> </span> </a>
</div>
<div class="links">
...
<div class="links">
	<a href="anno_ManageAll.action"><span style=" line-height:50px;"><font
			color="white">公 告 管 理</font> </span> </a>
</div>
<div class="links">
...
<div
	style="padding: 6px;margin-left: 5px;margin-right: 5px;margin-top:40px;font-size: 14px;line-height: 20px;color: white;float: left;font-family: 微软雅黑;	border: 1px solid #C2D5E3;">
