...
public class FileUpload {
	...
	public String userPicUpload() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(ServletActionContext.getRequest().getRealPath(savePath) + "\\"
				+ questionTime + getFileUploadFileName());
		// 以上传文件建立一个文件上传流
		...
		String p = request.getContextPath() + this.savePath + "/" + questionTime + getFileUploadFileName().toString();
